...
class Datum__ {
    ...
    @Expose
    var sunriseTime: Double? = null
    @SerializedName("sunsetTime")
    @Expose
    var sunsetTime: Double? = null
    ...
    @SerializedName("precipDoubleensityMax")
    @Expose
    var precipDoubleensityMax: Double? = null
    @SerializedName("precipDoubleensityMaxTime")
    @Expose
    var precipDoubleensityMaxTime: Double? = null
    ...
    @SerializedName("temperatureMDoubleime")
    @Expose
    var temperatureMDoubleime: Double? = null
    ...
    @SerializedName("apparentTemperatureMDoubleime")
    @Expose
    var apparentTemperatureMDoubleime: Double? = null
